...
var categories = [];
var cursor1 = db.equipment_categories.find().sort({_id: 1});
while(cursor1.hasNext()) {
    ...
    var packages = [];
    var cursor2 = db.equipment_category_items.find({category_id: obj1._id}).sort({_id: 1});
...
db.equipment.insert(categories);
